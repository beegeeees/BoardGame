...
public final class MessageTypes {
    ...
    public static final String FINISH_MICRO_GAME = "FINISH_MICRO_GAME";
    ...
    public static final String MINI_GAME_UPDATED = "MINI_GAME_UPDATED";
    public static final String MICRO_GAME_UPDATED = "MICRO_GAME_UPDATED";
